...
},{"sightglass":195}],195:[function(require,module,exports){
(function() {
...
},{"../router/router":201,"jquery":192,"underscore":196}],201:[function(require,module,exports){
'use strict';
...
function walls() {
  ...
  function appendWallPaperTemplate(index) {
    ...
    _jquery2["default"](".walls-generated").append(wallPaperTemplateString);
  ...
  function getOriginalWidth(quote) {
    _jquery2["default"]("#dummy").find(".quoteContainer").html(quote);
    var width = _jquery2["default"](".quoteContainer").innerWidth();
    _jquery2["default"]("#dummy").find(".quoteContainer").html("");
    return width;
  }
    ...
    _jquery2["default"]("#generate-wallpapers").on("click", function () {
      ...
      quotes.map(function (quote, i) {
        ...
        appendWallPaperTemplate(i).done(function () {
          ...
          _jquery2["default"]("#wallpaper" + i).css('background', 'url(' + images[Math.round(Math.random() * (images.length - 1))] + ') no-repeat center center');
